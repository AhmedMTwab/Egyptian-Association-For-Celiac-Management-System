...
namespace Egyptian_association_of_cieliac_patients.Migrations
{
    ...
    [Migration("20240702221322_orderpaymenthave")]
    partial class orderpaymenthave
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Egyptian_association_of_cieliac_patients.Models.CartMaterialHave", b =>
                {
                    ...
                    b.HasKey("MaterialId", "CartId");

                    b.HasIndex("CartId");

                    b.ToTable("cart_Material_have");
                });

            modelBuilder.Entity("Egyptian_association_of_cieliac_patients.Models.CartProductHave", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "eb3e8f2b-2f5d-4764-9f4d-9b4d00c8d469",
                            ConcurrencyStamp = "a4233711-e92d-4020-a836-88de20341d05",
                            Name = "Admin",
                            NormalizedName = "admin"
                        },
                        new
                        {
                            Id = "8872bcac-18e9-4a41-8d15-fc8cb5c5b4a1",
                            ConcurrencyStamp = "b7cb9743-83e6-4c2c-b605-300607896cb9",
                            Name = "UserManager",
                            NormalizedName = "usermanager"
                        },
                        new
                        {
                            Id = "cf71d772-8390-4744-906b-2f6e37a95d54",
                            ConcurrencyStamp = "eda6c94e-5378-4516-ac00-62f3db03121e",
                            Name = "StoreManager",
                            NormalizedName = "storemanager"
                        },
                        new
                        {
                            Id = "23f0c0dc-c516-4cb2-9a47-94d697921c8f",
                            ConcurrencyStamp = "1e9eee6d-0852-4c43-9c78-95c6c79fdfe6",
                            Name = "MedicalManager",
                            NormalizedName = "medicalmanager"
                        },
                        new
                        {
                            Id = "08756800-1cdb-4b7d-b537-05db00b37960",
                            ConcurrencyStamp = "98da8292-d46d-45e4-a5b2-6f98f9791251",
                            Name = "Doctor",
                            NormalizedName = "doctor"
                        },
                        new
                        {
                            Id = "e7b9027b-065f-4326-9b01-fbfef5fa0ff7",
                            ConcurrencyStamp = "5c9edde2-66d0-4478-a816-6773e9f20ac8",
                            Name = "NormalUser",
            ...
            modelBuilder.Entity("Egyptian_association_of_cieliac_patients.Models.Cart", b =>
                {
                    b.HasOne("Egyptian_association_of_cieliac_patients.Models.Patient", "Patient")
                        .WithOne("Cart")
                        .HasForeignKey("Egyptian_association_of_cieliac_patients.Models.Cart", "PatientId")
